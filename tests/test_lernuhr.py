...
class test_LernUhr(TestCase):
    ...
    def test_calibrate(self):
        ...
        self.assertEqual(100_000, objekt.calibrate(200_000).start_zeit)
        self.assertNotEqual(100_000, objekt.calibrate(200_000).now(200_000))
        self.assertEqual(100_000, objekt.calibrate(200_000).reset(200_000).now(200_000))
